import { CorePaletteColors, Scheme, CorePalette, rgbaFromArgb } from "@material/material-color-utilities";
...
export type MaterialCssVariablesOnDOM = {  [T in `--md-sys-color-${MaterialCSSVariables}`]: `${number} ${number} ${number}` };
...
const darkSchemeProperties = (colorPalette: CorePaletteColors) => {
  ...
  return {
    ...cssVariables,
    '--md-sys-color-surface-container-lowest': objectRGBAToRGBA(rgbaFromArgb(materialPalette.n1.tone(4))),
    '--md-sys-color-surface-container-low': objectRGBAToRGBA(rgbaFromArgb(materialPalette.n1.tone(10))),
    '--md-sys-color-surface-container': objectRGBAToRGBA(rgbaFromArgb(materialPalette.n1.tone(12))),
    '--md-sys-color-surface-container-high': objectRGBAToRGBA(rgbaFromArgb(materialPalette.n1.tone(17))),
    '--md-sys-color-surface-container-highest ': objectRGBAToRGBA(rgbaFromArgb(materialPalette.n1.tone(22))),
...
const lightSchemeProperties = (colorPalette: CorePaletteColors) => {
  ...
  return {
    ...cssVariables,
    '--md-sys-color-surface-container-lowest': objectRGBAToRGBA(rgbaFromArgb(materialPalette.n1.tone(100))),
    '--md-sys-color-surface-container-low': objectRGBAToRGBA(rgbaFromArgb(materialPalette.n1.tone(96))),
    '--md-sys-color-surface-container': objectRGBAToRGBA(rgbaFromArgb(materialPalette.n1.tone(94))),
    '--md-sys-color-surface-container-high': objectRGBAToRGBA(rgbaFromArgb(materialPalette.n1.tone(92))),
    '--md-sys-color-surface-container-highest ': objectRGBAToRGBA(rgbaFromArgb(materialPalette.n1.tone(90))),
  } as MaterialCssVariablesOnDOM
}
