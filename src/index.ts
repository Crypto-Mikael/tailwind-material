...
const corePaletteColorsFromCorePaletteColorsInHex = (colors: CorePaletteColorsInHex): CorePaletteColors => {
...
export default plugin.withOptions<CorePaletteColorsInHex>(
  (colors) => ({ addComponents, addBase, addUtilities }) => {
     addBase({
      '::view-transition': {
      ...
      'html[data-theme="light"]': {
        'color-scheme': 'light',
        ...lightSchemeProperties(corePaletteColorsFromCorePaletteColorsInHex(colors ?? { primary: '#F0AB1F' }))
      },
      'html[data-theme="dark"]': {
        'color-scheme': 'dark',
        ...darkSchemeProperties(corePaletteColorsFromCorePaletteColorsInHex(colors ?? { primary: '#F0AB1F' }))
      },
      'html': {
    ...
    return {
      theme: {
        ...
        colors: palette(corePaletteColorsFromCorePaletteColorsInHex(colors ?? { primary: '#F0AB1F' }))
      },
    }
})